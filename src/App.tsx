...
export const Bubble1 = styled.div<{ top?: string, left?: string }>`
  ...
  z-index: -2;
  border-radius: 50%;
  background: radial-gradient(circle, hsl(185 80% 55% / .4), hsl(185 50% 55% / .01) 70%, transparent 100%);
  height: 30rem;
  width: 30rem;
  top: ${({ top }) => top ? top : "0"};
...
export const Bubble2 = styled.div<{ top?: string, left?: string }>`
  ...
  z-index: -3;
  border-radius: 50%;
  background: radial-gradient(circle, hsl(220 80% 65% / .4), hsl(210 50% 65% / .01) 70%, transparent 100%);
  height: 45rem;
  width: 45rem;
  top: ${({ top }) => top ? top : "0"};
  left: ${({ left }) => left ? left : "0"};
...
export const Bubble3 = styled.div<{ top?: string, left?: string }>`
  ...
  z-index: -4;
  border-radius: 50%;
  background: radial-gradient(circle, hsl(225 80% 65% / .4), hsl(230 50% 55% / .01) 70%, transparent 100%);
